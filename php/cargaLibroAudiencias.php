<?php 
  ...
  require_once ('../lib/function.php');
          ...
          if (copy($_FILES['archivoExcel']['tmp_name'], $destino)) {
            ...
            header("Location: ../pages/libro-audiencias.html?error=error_copia_archivo");
            exit();
          }
          if (file_exists("bak_" . $archivo)) {
            try {
             ...
             if (!empty($_DATOS_EXCEL)) {
              ...
              // Eliminar el archivo temporal del servidor después de procesar
              ...
              // Si no hay datos, eliminar archivo y mostrar error
              if (file_exists($destino)) {
                unlink($destino);
              }
              header("Location: ../pages/libro-audiencias.html?error=archivo_sin_datos");
              exit();
             }
              ...
              header("Location: ../pages/libro-audiencias.html?error=error_procesamiento");
              exit();
            }
          ...
          //si por algo no cargo el archivo bak_ 
            ...
            // Intentar eliminar el archivo si existe aunque no se haya podido cargar
            if (file_exists($destino)) {
              unlink($destino);
            }
